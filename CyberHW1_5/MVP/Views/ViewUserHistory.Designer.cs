namespace CyberHW1_5.MVP.Views
{
    partial class ViewUserHistory
    {
        ...
        private void InitializeComponent()
        {
            ...
            groupBoxOut.Controls.Add(buttonBack);
            ...
            groupBoxOut.Size = new Size(276, 692);
            groupBoxOut.TabIndex = 8;
            groupBoxOut.TabStop = false;
            // 
            // buttonBack
            // 
            buttonBack.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            ...
            buttonBack.Location = new Point(9, 634);
            ...
            tableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
            tableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
            tableLayoutPanel.Location = new Point(282, 12);
            tableLayoutPanel.Name = "tableLayoutPanel";
            tableLayoutPanel.RowCount = 2;
            tableLayoutPanel.RowStyles.Add(new RowStyle());
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tableLayoutPanel.Size = new Size(732, 668);
            ...
            ClientSize = new Size(1026, 692);
            Controls.Add(tableLayoutPanel);
            Controls.Add(groupBoxOut);
            Name = "ViewUserHistory";
            Text = "ViewUserHistory";
            Load += ViewUserHistory_Load;
